...
fun Context.settings(): Settings {
    ...
    return Settings(
        appKey = prefs.getString(
            getString(R.string.pref_app_key), getString(R.string.pref_app_key_def_val)
        )!!,
        initUrl = prefs.getString(
            getString(R.string.pref_init_url), getString(R.string.pref_init_url_def_val)
        )!!,
        ...
        mockUserTargetingEnabled = prefs.getBoolean(
            getString(R.string.pref_mock_user_targeting_enabled),
            resources.getBoolean(R.bool.pref_mock_user_targeting_enabled_def_val)
        )
    )
}
